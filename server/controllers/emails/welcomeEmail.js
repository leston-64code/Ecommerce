          ...
          <tbody>
            <tr style="width:100%">
              <td><img alt="Koala" height="50" src="https://react-email-demo-ndjnn09xj-resend.vercel.app/static/koala-logo.png" style="display:block;outline:none;border:none;text-decoration:none;margin:0 auto" width="170" />
                ...
                <p style="font-size:16px;line-height:26px;margin:16px 0"><!-- -->Welcome aboard to [Your Ecommerce Platform]! 🎉<!-- -->,</p>
                <p style="font-size:16px;line-height:26px;margin:16px 0">We're thrilled to have you join our community of savvy shoppers. Get ready to embark on a seamless shopping journey filled with endless possibilities. Whether you're hunting for the latest trends or searching for everyday essentials, we've got you covered.
    <p style="font-size:16px;line-height:26px;margin:16px 0">Explore our curated collections, exclusive deals, and personalized recommendations tailored just for you. Plus, enjoy hassle-free shopping with secure transactions and speedy deliveries.</p>
    <p style="font-size:16px;line-height:26px;margin:16px 0">Feel free to reach out to our dedicated support team for any assistance you may need. Let's make your shopping experience extraordinary!</p>
